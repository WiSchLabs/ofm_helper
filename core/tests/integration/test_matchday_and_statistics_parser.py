...
class StatisticsParserTest(TestCase):
    def setUp(self):
        ...
        matchday_parser.url = open(os.path.join(TESTDATA_PATH, 'head.html'), encoding='utf8')
        self.parser = PlayerStatisticsParser(matchday_parser=matchday_parser)
    ...
    def test_parsed_player_stat_contains_all_foreign_keys(self):
        ...
        self.assertEquals(self.first_player_stat.matchday.number, 23)
        self.assertEquals(self.first_player_stat.matchday.season.number, 139)
    ...
    def test_parse_player_stat_should_return_same_instance_if_nothing_changes(self):
        ...
        self.parser.matchday_parser.url = open(os.path.join(TESTDATA_PATH, 'head.html'), encoding='utf8')
