...
class StadiumStandStatisticsParserTest(TestCase):
    ...
    def test_stadium_stand_stat_parser_north_stand(self):
        ...
        self.assertEquals(self.stadium_stand_stats[0].condition, '92.38')
        self.assertEquals(self.stadium_stand_stats[0].visitors, '81')
    ...
    def test_stadium_stand_stat_parser_east_stand(self):
        ...
        self.assertEquals(self.stadium_stand_stats[1].condition, '96.00')
        self.assertEquals(self.stadium_stand_stats[1].visitors, '100')
    ...
    def test_stadium_stand_stat_parser_south_stand(self):
        ...
        self.assertEquals(self.stadium_stand_stats[2].condition, '52.62')
        self.assertEquals(self.stadium_stand_stats[2].visitors, '83')
    ...
    def test_stadium_stand_stat_parser_west_stand(self):
        ...
        self.assertEquals(self.stadium_stand_stats[3].condition, '96.00')
        self.assertEquals(self.stadium_stand_stats[3].visitors, '100')
        self.assertEquals(self.stadium_stand_stats[3].ticket_price, '35')
