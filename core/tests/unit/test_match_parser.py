...
class MatchParserTest(TestCase):
    ...
    def test_match_home_team_statistics(self):
        ...
        self.assertEquals(self.match_stat.home_team_statistics.strength, '37')
        self.assertEquals(self.match_stat.home_team_statistics.ball_possession, '37.0')
        self.assertEquals(self.match_stat.home_team_statistics.chances, '2')
        self.assertEquals(self.match_stat.home_team_statistics.yellow_cards, '1')
    ...
    def test_match_guest_team_statistics(self):
        ...
        self.assertEquals(self.match_stat.guest_team_statistics.team_name, 'HJK Tantrum')
        self.assertEquals(self.match_stat.guest_team_statistics.strength, '63')
        self.assertEquals(self.match_stat.guest_team_statistics.ball_possession, '63.0')
        self.assertEquals(self.match_stat.guest_team_statistics.chances, '5')
        self.assertEquals(self.match_stat.guest_team_statistics.yellow_cards, '2')
