...
from core.ofm_views import PlayerDetailView, PlayerStatisticsView, PlayerStatisticsAsJsonView, FinanceDataView, \
    ...
    StadiumDetailView, StadiumStandStatisticsView, FinancesBalanceAsJsonView
...
urlpatterns = [
    ...
    url(r'^finances_balance_json/?$', FinancesBalanceAsJsonView.as_view(), name='finances_balance_json'),
