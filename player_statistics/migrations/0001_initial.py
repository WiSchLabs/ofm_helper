    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Season')),
                ('current_matchday', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.CurrentMatchday')),
            ],
            options={
                'ordering': ['position'],
            },
