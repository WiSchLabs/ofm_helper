"""
Django settings for ofm_helper project.
...
SECRET_KEY = '02agamp&$k@bzk14-a3f)g5+_t%l^n@8o*b-r+)_d(hx^jn@g3'
...
CRON_CLASSES = [
    ...
    "core.cron.parse_matches.MatchesCronJob",
]
